package com.cyh.flinkProject.isSpider.dataProcess.broadcast

import java.util

import com.cyh.flinkProject.isSpider.common.bean.{AnalyzeRule, BookRequestData, ProcessedData, QueryRequestData, RequestType, ResultData}
import com.cyh.flinkProject.isSpider.dataProcess.businessProcess.{AnalyzeBookRequest, AnalyzeRequest, DataSplit, DataStructured, EncryptionData, IpOperation}
