...
import com.cyh.flinkProject.isSpider.common.bean.AnalyzeRule
...
import com.cyh.flinkProject.isSpider.dataProcess.constants.{BehaviorTypeEnum, FlightTypeEnum}
