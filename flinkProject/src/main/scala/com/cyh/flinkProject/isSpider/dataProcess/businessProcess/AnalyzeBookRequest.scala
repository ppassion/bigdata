...
import com.cyh.flinkProject.isSpider.common.bean.{AnalyzeRule, BookRequestData, RequestType}
import com.cyh.flinkProject.isSpider.common.util.decode.{MD5, RequestDecoder}
import com.cyh.flinkProject.isSpider.common.util.json.JsonParser
import com.cyh.flinkProject.isSpider.common.util.xml.XmlUtil
import com.cyh.flinkProject.isSpider.dataProcess.constants.FlightTypeEnum
