package com.cyh.flinkProject.isSpider.common.util.xml

import java.io.StringReader

import com.cyh.flinkProject.isSpider.common.bean.{AnalyzeRule, BookRequestData}
import com.cyh.flinkProject.isSpider.dataProcess.constants.TravelTypeEnum
