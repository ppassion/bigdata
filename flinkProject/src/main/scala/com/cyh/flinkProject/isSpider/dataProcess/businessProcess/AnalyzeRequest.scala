...
import com.cyh.flinkProject.isSpider.common.bean.{AnalyzeRule, QueryRequestData, RequestType}
import com.cyh.flinkProject.isSpider.common.util.decode.RequestDecoder
