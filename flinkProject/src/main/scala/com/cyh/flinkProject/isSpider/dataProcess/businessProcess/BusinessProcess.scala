...
object BusinessProcess {
  ...
  def getFlinkJedisClusterConfig():FlinkJedisClusterConfig={
    ...
    //获取redis集群地址
    // redis.servers = 192.168.52.100:7001,192.168.52.100:7002,192.168.52.100:7003,192.168.52.100:7004,192.168.52.100:7005,192.168.52.100:7006
...
class MyRedisMapper1  extends RedisMapper[Tuple2[String,Int]]{
  ...
  override def getCommandDescription: RedisCommandDescription = {
    ...
    //设置插入数据到redis的命令，带上key的过期时间   set key  value
  ...
  override def getValueFromData(data: (String, Int)): String = {
     ...
     val map1 = new util.HashMap[String,Int]()
      ...
      map2.put("serversCountMap",map1)
     val jsonString: String = mapper.writeValueAsString(map2)
     println(jsonString)

    //返回json串   todo:{"serversCountMap":{"192.168.52.100":60}}
    jsonString
...
class MyRedisMapper2  extends RedisMapper[Tuple2[String,Int]]{
  ...
  override def getValueFromData(data: (String, Int)): String = {
    ...
    map2.put("activeNumMap",map1)    //todo: {"activeNumMap":{"192.168.52.100":33}}
    val jsonString: String = mapper.writeValueAsString(map2)
    println(jsonString)
