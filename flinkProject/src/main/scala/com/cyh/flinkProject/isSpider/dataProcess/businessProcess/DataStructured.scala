...
import com.cyh.flinkProject.isSpider.common.bean.{BookRequestData, CoreRequestParams, ProcessedData, QueryRequestData, RequestType}
import com.cyh.flinkProject.isSpider.dataProcess.constants.{BehaviorTypeEnum, TravelTypeEnum}
