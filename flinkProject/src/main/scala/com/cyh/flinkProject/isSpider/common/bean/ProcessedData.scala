package com.cyh.flinkProject.isSpider.common.bean

import com.cyh.flinkProject.isSpider.dataProcess.constants.BehaviorTypeEnum.BehaviorTypeEnum
import com.cyh.flinkProject.isSpider.dataProcess.constants.FlightTypeEnum.FlightTypeEnum
