...
import com.cyh.flinkProject.isSpider.common.bean.{AntiCalculateResult, FlowScoreResult, ProcessedData}
import com.cyh.flinkProject.isSpider.common.util.jedis.PropertiesUtil
import com.cyh.flinkProject.isSpider.dataProcess.broadcast.ProcessRuleBroadcastProcessFunction
import com.cyh.flinkProject.isSpider.dataProcess.businessProcess.QueryDataPackage
import com.cyh.flinkProject.isSpider.dataProcess.mysqlSource.MysqlProcessRuleSource
...
object ComputeLauncher {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //todo: 13、黑名单保存redis    flink -connector-redis
