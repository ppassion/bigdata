package com.cyh.flinkProject.isSpider.common.util.database;
...
public class C3p0Util {
    ...
    private static void createConnectionPool(){
        ...
        try {
            ...
            cpds.setAcquireRetryAttempts(new Integer(prop.getProperty("acquireRetryAttempts")));
            cpds.setAcquireRetryDelay(new Integer(prop.getProperty("acquireRetryDelay")));
